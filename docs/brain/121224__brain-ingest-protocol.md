...
- Trigger phrases: Any variant of "add to brain," "put this in Mise's brain," "codify this," "remember this," "remember this:," "save that to your brain," "don't forget 'x'," "dont forget this:," "this is now part of the fabric of Mise," or the single word "new" (triggers initialization protocol from claude_new file).
- Naming: Brain ingest files must use mmddyy format in filenames (e.g., 121224__<slug>.md) and reside in docs/brain.
- Absolute Memory Rule: Every permanent instruction/config/meta-rule must create a new mmddyy-named brain doc; no ephemeral learning.
