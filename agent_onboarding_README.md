...
Defaults and Bases
- Transcripts base (LPM): ~/mise-core/payroll_agent/LPM (override with LPM_TRANSCRIPTS_BASE)
- Transcription outputs: ~/mise-core/payroll_agent/LPM
- Inventory assets: data/Inventory/, inventory_agent/
- Cloud payroll (CPM): payroll_agent/CPM/engine/, payroll_agent/CPM/transcribe/
- Local payroll (LPM): payroll_agent/LPM/
